<template>
    <div class="login-wrap">
        <el-switch v-model="isDark" class="theme-btn" style="margin-left: 24px" inline-prompt :active-icon="Moon"
        ...
        <div class="loogin-container">
            ...
            <el-form :model="sendData" class="form-wrap" ref="ruleFormRef" autocomplete="off">
                <el-form-item prop="staff_account">
                    <el-input class="login-input" v-model="sendData.staff_account" placeholder="请输入账号或手机号"
                        :prefix-icon="User"></el-input>
                </el-form-item>
                <el-form-item prop="password">
                    <el-input class="login-input" v-model="sendData.password" placeholder="请输入密码" show-password
                        :prefix-icon="Lock"></el-input>
                </el-form-item>
            </el-form>
            <!-- 忘记密码 -->
            <div class="other-wrap">
                <el-button type="primary" link @click="showResetPasswordHandle">忘记密码？</el-button>
            </div>
            <el-button class="login-btn" type="primary" :loading="loginLoading" @click="login">登录</el-button>
        </div>
        <reset-password class="reset-password" v-if="showResetPassword"
            @update:showResetPassword="showResetPassword = $event"></reset-password>
    </div>
</template>
...
function login() {
    console.log('login', sendData.staff_account, sendData.password);
}
